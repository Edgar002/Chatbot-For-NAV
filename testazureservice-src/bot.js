...
const { BlackGuyImage } = require('./dialogs/blackguy');
            ...
            if (!dc.context.responded) {
                ...
                case DialogTurnStatus.empty:
                    ...
                    case GREETING_INTENT:
                        ...
                        await dc.context.sendActivity(`Hi , I'm PolyAsia Agent.`);
                    ...
                    default:
                        ...
                        await context.sendActivity({ attachments: [blackGuy] });
                        break;
                    }
                    break;
                default:
            ...
            if (context.activity.membersAdded.length !== 0) {
                ...
                for (var idx in context.activity.membersAdded) {
                    ...
                    if (context.activity.membersAdded[idx].id !== context.activity.recipient.id) {
                        ...
                        await dc.context.sendActivity(`Hi I'm PolyAsia Agent.`);
                        await dc.context.sendActivity(`Please tell me what can I help you`);
                    }
                }
            }
        }
